<?php
/**
 * Single Lab item — a build log, not a polished case study.
 */
get_header();
			...
			<article <?php post_class(); ?>>
				<header class="single-lab__header">
					<a class="single-lab__back" href="<?php echo esc_url( get_post_type_archive_link( 'sayid_lab' ) ); ?>">
						&rarr; <?php esc_html_e( 'همه‌ی آزمایشگاه', 'sayid-site-core' ); ?>
					</a>
					<?php if ( $status_label ) : ?>
					...
					<dl class="single-lab__meta">
						<?php if ( $started_at ) : ?>
							<div><dt><?php esc_html_e( 'شروع', 'sayid-site-core' ); ?></dt><dd><?php echo esc_html( $started_at ); ?></dd></div>
						<?php endif; ?>
						<?php if ( $shipped_at ) : ?>
							<div><dt><?php esc_html_e( 'انتشار', 'sayid-site-core' ); ?></dt><dd><?php echo esc_html( $shipped_at ); ?></dd></div>
						<?php endif; ?>
						<?php if ( $tools ) : ?>
							<div><dt><?php esc_html_e( 'ابزارها', 'sayid-site-core' ); ?></dt><dd><?php echo esc_html( $tools ); ?></dd></div>
						<?php endif; ?>
					</dl>

					<div class="single-lab__links">
						<?php if ( $repo_url ) : ?>
							<a class="btn btn--ghost" href="<?php echo esc_url( $repo_url ); ?>" target="_blank" rel="noopener"><?php esc_html_e( 'ریپازیتوری', 'sayid-site-core' ); ?></a>
						<?php endif; ?>
						<?php if ( $live_url ) : ?>
							<a class="btn btn--primary" href="<?php echo esc_url( $live_url ); ?>" target="_blank" rel="noopener"><?php esc_html_e( 'مشاهده‌ی زنده', 'sayid-site-core' ); ?></a>
						<?php endif; ?>
					</div>
				</header>

				<?php if ( has_post_thumbnail() ) : ?>
					<div class="single-lab__cover"><?php the_post_thumbnail( 'large' ); ?></div>
				<?php endif; ?>
