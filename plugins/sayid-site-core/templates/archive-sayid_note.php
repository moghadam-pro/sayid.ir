<?php
/**
 * Notes archive — the same flat editorial list pattern as the homepage
 * Latest Notes section, just with pagination and no limit.
 */
get_header();
?>
<main class="section archive-notes">
	<div class="site-container editorial-width">
		<header class="archive__header">
			<h1 class="archive__title"><?php esc_html_e( 'یادداشت‌ها', 'sayid-site-core' ); ?></h1>
			<p class="archive__lede"><?php esc_html_e( 'ایده‌ها، مشاهده‌ها و درس‌های کوتاهی که در مسیر ساختن و طراحی جمع می‌شن.', 'sayid-site-core' ); ?></p>
		</header>
		...
		<?php else : ?>
			<p class="archive__empty"><?php esc_html_e( 'هنوز یادداشتی منتشر نشده.', 'sayid-site-core' ); ?></p>
		<?php endif; ?>
	</div>
</main>
<?php
