<?php
/**
 * Topic archive — mixed post types (Articles, Notes, Lab, Projects) that
 * share this taxonomy, in one reverse-chronological stream. This is the
 * cross-content discovery page described in docs/02-content-model.md §3.
 */
get_header();
...
<main class="section archive-topic">
	<div class="site-container editorial-width">
		<header class="archive__header">
			<p class="archive__eyebrow"><?php esc_html_e( 'موضوع', 'sayid-site-core' ); ?></p>
		...
		<?php else : ?>
			<p class="archive__empty"><?php esc_html_e( 'هنوز محتوایی با این موضوع منتشر نشده.', 'sayid-site-core' ); ?></p>
		<?php endif; ?>
	</div>
</main>
<?php
