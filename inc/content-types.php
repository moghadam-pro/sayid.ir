...
function sayid_register_post_types() {
	...
	register_post_type( 'sayid_project', array(
		'labels'            => array(
			'name'          => __( 'نمونه‌کارها', 'sayid' ),
			'singular_name' => __( 'نمونه‌کار', 'sayid' ),
			'add_new'       => __( 'نمونه‌کار جدید', 'sayid' ),
			'add_new_item'  => __( 'افزودن نمونه‌کار جدید', 'sayid' ),
			'edit_item'     => __( 'ویرایش نمونه‌کار', 'sayid' ),
			'new_item'      => __( 'نمونه‌کار جدید', 'sayid' ),
			'view_item'     => __( 'مشاهده نمونه‌کار', 'sayid' ),
			'search_items'  => __( 'جست‌وجوی نمونه‌کارها', 'sayid' ),
			'not_found'     => __( 'نمونه‌کاری پیدا نشد', 'sayid' ),
			'all_items'     => __( 'همه‌ی نمونه‌کارها', 'sayid' ),
			'menu_name'     => __( 'نمونه‌کارها', 'sayid' ),
		),
		'public'            => true,
		'show_in_rest'      => true,
